      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-600">Encontre tudo aqui que disponiblizamos e podemos oferecer.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col h-full items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Consultoria Especializada</h4>
              <p className="text-gray-600 text-center">Nossos especialistas auxiliam na implementação de práticas sustentáveis de gerenciamento de resíduos, otimizando processos e reduzindo custos.</p>
            </div>
            ...
            <div className="relative flex flex-col h-full items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Treinamento e Capacitação</h4>
              <p className="text-gray-600 text-center">Oferecemos programas de treinamento para equipes, promovendo a conscientização sobre a importância do gerenciamento de resíduos e como fazê-lo de maneira eficaz.</p>
            </div>
            ...
            <div className="relative flex flex-col h-full items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Monitoramento Contínuo</h4>
              <p className="text-gray-600 text-center">Mantenha-se informado sobre o progresso sustentável. Monitoramos e avaliamos regularmente o impacto positivo de nossas soluções.</p>
            </div>
